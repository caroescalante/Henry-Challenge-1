  ...
  class Persona {
    ...
    getFriends() {
      ...
      for (var i=0;i<Persona.amigos.length;i++){
        array=this.Persona.amigos.nombre
      }
      return array
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
        Persona.amigos.prototype.promedad=function(edad){
            for(var i=0;i<this.amigos.length;i++){
              acum=acum+edad
            }
            return acum/(Persona.amigos.length)
        }
    }
  };
